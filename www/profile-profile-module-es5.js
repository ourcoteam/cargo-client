...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(authService, apiService, router, _translate) {
        var _this = this;
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (event) {
          ...
          if (route.url === '/tabs/profile') {
            if (_this.authService.isAuthenticated()) {
              _this.authService.getWallet(_this.authService.userToken);
            }
          }
        });
      }
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return this.authService.returnUserLang().then(function (lang) {
                      // console.log(lang);
                      _this2.userLang = lang; // console.log(this.userLang);
                    });
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    this.authService.changeUserLang(this.userLang).then(function () {// console.log(this.authService.userData.language);
                    });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateService"]])], ProfilePage);
    /***/
  }
}]);
