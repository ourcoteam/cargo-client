...
let RegisterPage = class RegisterPage {
    constructor(platform, loadingCtrl, toastCtrl, apiService, formBuilder, navCtrl, authService, _translate, router) {
                ...
                if (this.lat && this.lng) {
                    ...
                    this.apiService.registerClient(registerData).subscribe((userData) => {
                        if (userData && userData.token && userData.user) {
                            ...
                            this.toNextStep();
                            this.showToast(this._translate.instant('general.account_created_successfully'), 2000, 'bottom', 'success');
                            setTimeout(() => {
